...
async function run() {
  ...
  // Split on double newlines or semicolons outside functions
  const statements = [
    // 1. durable_jobs table
    ...
    // 7. lead_generation_targets table
    ...
    // 10. claim_next_durable_job function
  ...
  console.log("\n🎉 All 10 migration statements applied successfully!");
  process.exit(0);
}

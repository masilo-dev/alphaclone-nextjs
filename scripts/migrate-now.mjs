  ...
  for (let i = 0; i < statements.length; i++) {
    ...
    try {
      ...
      if (error.message.includes("already exists")) {
        ...
        failed++;
        console.log(
          `   ⚠️  Statement ${i + 1} issue: ${error.message.substring(0, 100)}`,
        );
      }
    }
  }
...
async function main() {
  ...
  console.log(
    "Use your database dashboard SQL editor when manual execution is needed.\n",
  );

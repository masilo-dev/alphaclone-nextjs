...
const SITE_PAGES = [
  ...
  { href: '/privacy-policy', title: 'Privacy Policy', description: 'How we collect, use, and protect data.' },
  { href: '/terms-of-service', title: 'Terms of Service', description: 'Billing, usage rules, AI features, and liability.' },
  { href: '/cookie-policy', title: 'Cookie Policy', description: 'Cookie controls and preference management.' },

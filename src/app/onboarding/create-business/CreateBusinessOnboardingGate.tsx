      ...
      <main className="min-h-screen bg-slate-950 text-slate-100">
        <div className="mx-auto flex min-h-screen max-w-4xl flex-col justify-center px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex gap-3">
            <Link href="/auth/login?register=true&type=business&plan=starter" className="rounded-lg bg-teal-500 px-4 py-2 type-ui font-semibold text-slate-950 hover:bg-teal-400">
              Sign up
            </Link>
            <Link href="/auth/login" className="rounded-lg border border-slate-700 bg-slate-900 px-4 py-2 type-ui font-semibold text-slate-200 hover:bg-slate-800">
              Sign in
            </Link>
          </div>
        </div>

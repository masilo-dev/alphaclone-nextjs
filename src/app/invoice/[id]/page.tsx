                        ...
                        {isPaid ? (
                            <Card className="p-5 sm:p-8 border-teal-500/30 bg-teal-500/10 text-center space-y-6">
                                ...
                                <div className="pt-4 mt-4 border-t border-teal-500/20">
                                    <p className="type-caption text-teal-500 font-mono uppercase tracking-widest">Transaction Verified</p>
                                </div>
                            </Card>
                        ) : pendingBank ? (
                            ...
                            <div className="space-y-6">
                                <Card className="p-5 sm:p-8 border-slate-800 bg-slate-900 shadow-2xl space-y-7">
                                    ...
                                    <div className="flex items-center justify-center gap-4 opacity-30">
                                        <span className="type-caption">VISA</span>
                                        <span className="type-caption">MASTERCARD</span>
                                        <span className="type-caption">STRIPE</span>
                                        <span className="type-caption">EFT</span>
                                    </div>
                                </Card>

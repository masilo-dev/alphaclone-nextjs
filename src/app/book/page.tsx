      ...
      <div className="max-w-lg w-full rounded-2xl border border-white/10 bg-slate-900/80 p-8 space-y-6 text-center">
        ...
        <div className="flex flex-col gap-3">
          ...
          <a
            ...
            className="inline-flex items-center justify-center rounded-xl border border-white/10 bg-slate-800 hover:bg-slate-700 px-5 py-3 type-ui font-semibold transition-colors"
          >

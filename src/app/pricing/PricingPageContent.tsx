...
const plans = [
    {
        ...
        features: [
            ...
            'Core CRM pipeline (unlimited contacts)',
            'Invoicing & basic financial suite',
            'Contract engine (3 templates)',
    ...
    },
    {
        ...
        price: '45',
        users: '25',
        desc: 'Full power for growing teams — everything you need to scale.',
        highlight: true,
        color: 'teal',
        features: [

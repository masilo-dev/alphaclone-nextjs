...
export default function robots(): MetadataRoute.Robots {
    ...
    return {
        rules: [
            ...
            {
                userAgent: 'GPTBot',
                allow: ['/', '/services', '/about', '/guide', '/docs', '/pricing', '/blog', '/ecosystem', '/who-we-serve', '/contact', '/tools/ai-architect', '/llms.txt', '/auth/login', '/legal', '/platform-status', '/security-policy', '/compliance', '/crm', '/lead-management', '/project-management', '/ai-agents', '/video-meetings', '/claude-manus-integrations', '/api/mcp/', '/api/mcp'],
            ...
            {
                userAgent: 'Applebot',
                allow: ['/', '/auth/login', '/legal', '/platform-status', '/security-policy', '/compliance', '/crm', '/lead-management', '/project-management', '/ai-agents', '/video-meetings', '/claude-manus-integrations', '/api/mcp/', '/api/mcp'],
                disallow: ['/dashboard', '/api/', '/auth/reset-password', '/private-docs/'],
            },

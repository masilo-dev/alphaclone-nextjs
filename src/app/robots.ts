    ...
    return {
        rules: [
            // Standard search engines — full access to marketing pages
            {
                ...
                allow: ['/'],
                disallow: ['/dashboard', '/api/', '/api/mcp', '/api/mcp/', '/mcp', '/mcp/', '/auth/reset-password', '/private-docs/', '/admin/'],
            },
            ...
            // but must NOT index private user data routes
            {
                ...
                disallow: ['/dashboard', '/api/', '/api/mcp', '/api/mcp/', '/mcp', '/mcp/', '/auth/reset-password', '/private-docs/', '/invoice/', '/project/', '/book/', '/meet/', '/call/'],
            },

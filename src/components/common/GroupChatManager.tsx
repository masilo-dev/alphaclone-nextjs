          ...
          {activeTab === 'create' ? (
            <div className="space-y-4">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-teal-600 px-4 py-3 type-ui font-semibold text-white transition-colors hover:bg-teal-500 disabled:cursor-not-allowed disabled:opacity-50 min-h-11"
              >
                {isCreating ? (

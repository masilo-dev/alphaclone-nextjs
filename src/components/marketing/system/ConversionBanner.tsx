...
export function ConversionBanner({
  ...
  return (
    <div className="relative overflow-hidden rounded-[var(--marketing-radius-lg)] border border-[rgba(38,193,193,0.28)] bg-gradient-to-br from-[rgba(38,193,193,0.16)] via-[var(--marketing-surface)] to-[var(--marketing-bg-secondary)] p-8 sm:p-10">

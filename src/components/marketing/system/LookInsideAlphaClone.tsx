...
const TABS: FeatureTab[] = [
  {
    ...
    metrics: [
      { label: "Execution", value: "Tracked", change: "Illustrative workflow", positive: true },
      { label: "Approvals", value: "Visible", change: "Owner controlled", positive: true },
      { label: "Business Context", value: "Connected", change: "Workspace scoped", positive: true },
    ],
    disclosures: [
      {
        title: "Autonomous Prospecting & Qualification",
        detail: "Researches permitted sources, checks available contact data, and prepares enriched records for review.",
        status: "completed",
        tag: "Example completed",
      },
      {
  ...
  },
  {
    ...
    metrics: [
      { label: "Customer Context", value: "Unified", change: "Illustrative view", positive: true },
      { label: "Handoffs", value: "Connected", change: "Across workflows", positive: true },
      { label: "Audit History", value: "Visible", change: "Action tracked", positive: true },
    ],
    disclosures: [
      {
  ...
  },
  {
    ...
    badge: "Identity-scoped publishing",
    icon: Share2,
    heading: "Publish through the social identities your workspace authorizes.",
    description: "Prepare and publish content through supported connected accounts, with identity resolution, approval controls, and execution tracking.",
    ...
    metrics: [
      { label: "Destination", value: "Resolved", change: "Illustrative status", positive: true },
      { label: "Permission", value: "Verified", change: "Before publishing", positive: true },
      { label: "Provider Result", value: "Tracked", change: "Receipt recorded", positive: true },
    ],
    disclosures: [
      {
        title: "Supported Social Publishing",
        detail: "Publish supported formats through connected social identities and current provider capabilities.",
        status: "completed",
        tag: "Connected",
      },
      {
        title: "LinkedIn Corporate Page Updates",
        detail: "Publish professional updates to an authorized personal or organization identity and record the provider result.",
        status: "completed",
        tag: "Live sync",
      },
      {
  ...
  },
  {
    ...
    metrics: [
      { label: "Invoice State", value: "Tracked", change: "Illustrative workflow", positive: true },
      { label: "Payment Status", value: "Connected", change: "Provider reported", positive: true },
      { label: "Ledger Context", value: "Available", change: "Workspace scoped", positive: true },
    ],
    disclosures: [
      {

...
export default function AllInOnePlatformShowcase() {
  ...
  return (
    <div className="w-full my-12 text-slate-100 select-none">
      ...
      {/* Main Image Showcase — seamless, non-interactive */}
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          <div className="relative mx-auto w-full aspect-[16/10] max-h-[520px]">
            <Image
            ...
            />
            <div
              className="pointer-events-none absolute inset-x-0 top-0 h-16 bg-gradient-to-b from-slate-950/80 to-transparent"
              aria-hidden="true"
            />
            <div
              className="pointer-events-none absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-slate-950/90 to-transparent"
              aria-hidden="true"
            />
          </div>

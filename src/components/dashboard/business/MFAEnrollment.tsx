                    ...
                    <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-700">
                        ...
                        <div className="flex flex-col md:flex-row gap-6 items-start">
                            <div className="bg-white p-2 rounded-xl">
                                ...
                                <div dangerouslySetInnerHTML={{ __html: qrCodeData }} className="w-40 h-40" />
                            </div>

                            <div className="flex-1 w-full space-y-4">
                                <div>
                                    <label className="text-xs text-slate-500 font-medium uppercase tracking-wider">Setup Key (Manual Entry)</label>
                                    <div className="flex bg-slate-800 rounded-lg p-3 text-sm font-mono text-slate-300 mt-1">
                                        {secret}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-3 mt-1">
                                        ...
                                        <Button
                                            ...
                                            isLoading={verifying}
                                            className="bg-teal-500 hover:bg-teal-400 text-black font-bold whitespace-nowrap px-6 h-12"
                                        >
                                            Verify & Save
                                        </Button>
                                    </div>
                                    <p className="text-xs text-slate-500 mt-2">Enter the 6-digit code generated by your app to verify setup.</p>
                                </div>
                            </div>
                        </div>
                    </div>

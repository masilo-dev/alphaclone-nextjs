            ...
            {reconnectRequired && (
                <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-2xl flex items-center justify-between animate-pulse">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-red-200 type-card-description font-bold">Re-authentication Required</p>
                            <p className="text-red-500/70 type-card-description">Your Calendly connection has expired or been revoked.</p>
                        </div>
                    </div>
                    <button
                        ...
                        {isConnected ? (
                            <>
                                ...
                                <a
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-teal-500 hover:bg-teal-600 text-slate-900 type-ui font-bold rounded-lg transition-all"
                                >
                            ...
                            <div className="flex flex-col gap-3 items-end">
                                <button
                                    onClick={handleConnect}
                                    disabled={connecting}
                                    className="flex items-center gap-2 px-6 py-2.5 bg-teal-500 hover:bg-teal-600 text-slate-900 font-black type-caption uppercase tracking-widest rounded-xl shadow-lg shadow-teal-500/20 transition-all active:scale-95 disabled:opacity-50"
                                >
                                    {connecting ? (

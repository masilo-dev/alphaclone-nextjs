    ...
    if (status === 'loading') {
        return (
            <div className="ac-workspace-panel rounded-lg p-8 text-center">
                ...
                <p className="type-card-description text-slate-400">Verifying SendGrid connection...</p>
            </div>
        );
    }
            ...
            <div className="p-6 border-b border-white/5 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="type-card-description text-slate-400">Connect your SendGrid account to send emails from your own domain.</p>
                    </div>
                </div>
                {status === 'connected' && (
                    <Button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full rounded-lg border border-slate-800 bg-slate-950/50 px-4 py-3 pl-10 type-ui text-white outline-none focus:border-indigo-500/40"
                            />
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full rounded-lg border border-slate-800 bg-slate-950/50 px-4 py-3 type-ui text-white outline-none focus:border-indigo-500/40"
                        />
                    </div>
                    <div className="space-y-2">

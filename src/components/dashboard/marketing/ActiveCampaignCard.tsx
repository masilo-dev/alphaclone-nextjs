    ...
    <div className="ac-workspace-panel p-4 space-y-3">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <h3 className="type-ui font-semibold text-[var(--ws-text-primary)] truncate">{campaign.name}</h3>
          <span
            className={cn(
        ...
        {campaign.total > 0 && (
          <span className="type-ui font-mono text-[var(--ws-text-secondary)] shrink-0">
      ...
      {campaign.total > 0 && (
        <div className="space-y-1.5">
          <div className="flex items-center justify-between type-ui text-[var(--ws-text-secondary)]">
      ...
      {!compact && (
        <div className="grid grid-cols-4 gap-2 text-center">
          <div>
            <p className="type-caption text-[var(--ws-text-secondary)] uppercase">Sent</p>
            <p className="type-card-description font-semibold text-[var(--ws-text-primary)]">{campaign.sent}</p>
          </div>
          <div>
            <p className="type-caption text-[var(--ws-text-secondary)] uppercase">Failed</p>
            <p className={cn('type-card-description font-semibold', campaign.failed > 0 ? 'text-red-400' : 'text-[var(--ws-text-primary)]')}>
              {campaign.failed}
            </p>
          </div>
          <div>
            <p className="type-caption text-[var(--ws-text-secondary)] uppercase">Replied</p>
            <p className={cn('type-card-description font-semibold', campaign.replied > 0 ? 'text-emerald-400' : 'text-[var(--ws-text-primary)]')}>
              {campaign.replied}
            </p>
          </div>
          <div>
            <p className="type-caption text-[var(--ws-text-secondary)] uppercase">Remaining</p>

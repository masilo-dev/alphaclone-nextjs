...
const AerialLeadNavigator: React.FC<AerialLeadNavigatorProps> = ({ leads, onClose }) => {
    ...
    // Navigation Loop
    useEffect(() => {
        if (!map || geocodedLeads.length === 0 || isNavigating) return;
            ...
            <div className="absolute inset-0 pointer-events-none border-[20px] border-slate-950/20">
                ...
                <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <button
                            onClick={onClose}
                            className="bg-white text-black px-6 py-3 rounded-full font-bold text-sm tracking-wide hover:bg-teal-400 transition-colors pointer-events-auto"
                        >
                            FINALIZE RESULTS
                        </button>
                    </div>

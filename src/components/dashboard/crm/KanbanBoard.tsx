    ...
    >
      ...
      >
          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-1 mt-0.5">
                {lead.industry && (
                  <span className="type-ui font-medium px-1.5 py-0.5 rounded bg-slate-800 text-slate-400 truncate max-w-full">
                    {lead.industry}
                  </span>
                )}
                ...
                {/* Client stage pill */}
                <span className="type-caption font-extrabold px-1.5 py-0.5 rounded-full bg-slate-950 border border-slate-800 text-slate-400 uppercase tracking-wider">
                  {lead.stage}
                </span>
              </div>
            </div>
        ...
        {(lead.email || lead.phone || lead.location) && (
          <div className="flex flex-wrap gap-x-3 gap-y-1 type-caption text-slate-400">
            {lead.location && (
  ...
  return (
    ...
    >
      <div className="p-3 bg-slate-900/50 backdrop-blur-sm border-b border-slate-800 flex items-center justify-between sticky top-0 z-10">
        <h3 className="font-bold type-ui text-slate-200 flex items-center gap-2">
            {column.title}
            <span className="type-caption bg-slate-800 px-2 py-0.5 rounded-full text-slate-400 font-medium">
                {leads?.length || 0}
            </span>
        </h3>
      </div>
      ...
      <div ref={setNodeRef} className="flex-1 min-h-[240px] max-h-[min(72vh,640px)] p-2 overflow-y-auto flex flex-col gap-2 relative">
        ...
        {leads.length === 0 && (
            <div className="pointer-events-none absolute inset-0 m-4 border-2 border-dashed border-slate-600/30 rounded-xl flex items-center justify-center type-caption text-slate-400 font-medium text-center px-4">
            ...
            <div className="flex-1 overflow-y-auto p-6 custom-scrollbar pb-12 space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <span className="type-caption font-black uppercase tracking-widest text-slate-500 font-mono">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="type-caption text-slate-400">Trust Score: <span className="text-[var(--brand-blue-400)] font-bold">{lead.trustScore || 'N/A'}</span></span>
                  </div>
                </div>
              ...
              <div className="bg-slate-900/50 border border-white/5 rounded-3xl p-4">
                <p className="type-caption font-black uppercase tracking-widest text-slate-500 font-mono mb-3 text-center">
                  ...
                  {KANBAN_STAGES.map((stage) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className={`type-caption font-mono uppercase tracking-wider ${isActive ? 'text-white font-bold' : 'text-slate-500'}`}>
                          {stage.title.split(' ')[0]}
                        </span>
                      </button>
                    );
              ...
              <div className="grid grid-cols-3 gap-3">
                {lead.phone ? (
                  ...
                  >
                    ...
                    <span className="type-caption font-black uppercase tracking-widest text-slate-300 font-mono">Call</span>
                  </a>
                ) : (
                ...
                {lead.email ? (
                  ...
                  >
                    ...
                    <span className="type-caption font-black uppercase tracking-widest text-slate-300 font-mono">Email</span>
                  </button>
                ) : (
                  <div className="flex flex-col items-center gap-2 p-3 bg-slate-900/30 border border-dashed border-white/5 rounded-2xl opacity-40">
                ...
                {lead.location ? (
                  ...
                  >
                    ...
                    <span className="type-caption font-black uppercase tracking-widest text-slate-300 font-mono">Locate</span>
                  </a>
                ) : (
                  <div className="flex flex-col items-center gap-2 p-3 bg-slate-900/30 border border-dashed border-white/5 rounded-2xl opacity-40">
              ...
              {lead.sdrInsight && (
                <div className="bg-slate-900/40 border border-white/5 rounded-3xl p-5 space-y-3">
                  ...
                  <p className="type-card-description text-slate-300 leading-relaxed font-sans bg-slate-950/40 p-3.5 rounded-2xl border border-white/5">
                    {lead.sdrInsight}
                  </p>
                </div>
              )}

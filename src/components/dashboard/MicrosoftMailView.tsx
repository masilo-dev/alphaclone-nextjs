                            ...
                            return (
                                ...
                                >
                                    <div className="flex justify-between items-start mb-1 gap-2">
                                        <span className="type-caption font-bold text-blue-400 truncate max-w-[140px] uppercase tracking-wider">
                                            {activeLabel === 'sent'
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {threadMessages[0]?.webLink && (
                                    <a
                                        ...
                                        className="type-caption text-blue-400 hover:text-blue-300 font-bold px-3 py-1.5 border border-blue-500/20 hover:bg-blue-500/10 rounded-xl transition-all"
                                    >
                                        View in Outlook
                                    </a>
                                )}

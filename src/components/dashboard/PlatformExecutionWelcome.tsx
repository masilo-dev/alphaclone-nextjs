      ...
      <div className="relative flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <h2 className="mt-1 text-base font-semibold text-white sm:text-lg">{copy.title}</h2>
            <p className="mt-1.5 max-w-2xl text-sm leading-relaxed text-slate-300">{copy.body}</p>
          </div>
        </div>

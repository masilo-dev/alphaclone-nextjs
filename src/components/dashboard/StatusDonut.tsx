...
export function StatusDonut({
  ...
  return (
    <div className="bg-surface-1 rounded-lg p-4 md:p-5 h-full min-h-[280px] flex flex-col">
      ...
      {total === 0 ? (
        <div className="flex-1 flex items-center justify-center type-caption text-slate-500">No status data</div>
      ) : (
        <div className="flex-1 flex items-center gap-4 min-h-0">
          ...
          <div className="flex-1 space-y-2 min-w-0">
            {segments.map((seg) => {
              ...
              return (
                <div key={seg.label} className="flex items-center gap-2 type-caption">

<<<<<<< HEAD
/**
 * @deprecated Old landing designs are retired.
 * Homepage always renders the current marketing system page.
 */
export { default } from '@/components/marketing/system/MarketingHomePage';
=======
'use client';

            ...
            <section id="home" className="pt-24 pb-16 lg:pt-48 lg:pb-32 relative overflow-hidden">
               ...
               <div className="max-w-5xl mx-auto px-4 text-center">
                  ...
                  <motion.div
                     ...
                     className="flex flex-col items-center justify-center gap-6 px-4 sm:px-0 mb-12"
                  >
                     ...
                     <button
                        ...
                        className="flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-700 font-semibold px-8 h-14 rounded-lg border border-gray-300 transition-all hover:scale-105 shadow-lg w-full sm:w-auto max-w-md"
                     >

...
export function PrivacyRequestCentre() {
  ...
  return <main className="min-h-screen bg-slate-950 px-4 py-12 text-slate-100"><form onSubmit={submit} className="mx-auto max-w-2xl rounded-2xl border border-white/10 bg-slate-900 p-6 sm:p-8">
    <p className="type-card-description font-medium text-teal-300">Privacy request centre</p><h1 className="mt-1 text-3xl font-semibold">Make a privacy request</h1>
    ...
    <div className="mt-7 grid gap-5">
      ...
      <p id="tenant-help" className="-mt-4 type-card-description text-slate-400">Use the organisation ID shown in the privacy notice or communication you received.</p>

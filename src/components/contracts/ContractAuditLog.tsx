        ...
        <div className="space-y-6">
            ...
            <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2 px-3 py-1 bg-teal-500/10 rounded-full border border-teal-500/20">
                        ...
                        <span className="type-caption font-bold text-teal-400 uppercase tracking-widest">ESIGN COMPLIANT</span>
                    </div>
                </div>
                                ...
                                sigEvents.map((event) => (
                                    <div key={event.id} className="p-5 bg-slate-900 border border-teal-900/30 rounded-xl space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div>
                                                <label className="flex items-center gap-1.5 type-caption font-bold text-teal-500/70 uppercase tracking-widest mb-1">
                                                    <Lock className="w-3 h-3" /> Tamper-Proof Cryptographic Seal
                                                </label>
                                                <div className="p-2 bg-teal-950/20 rounded border border-teal-500/20 type-caption font-mono text-teal-400 break-all leading-relaxed">
                                                    {event.tamper_seal}
                                                </div>
                                            </div>
                                        </div>
            ...
            <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-4 flex gap-4">
                ...
                <div className="space-y-1">
                    <h4 className="type-ui font-bold text-amber-200">Integrity Verification Notice</h4>
                    <p className="type-card-description text-amber-200/60 leading-relaxed">

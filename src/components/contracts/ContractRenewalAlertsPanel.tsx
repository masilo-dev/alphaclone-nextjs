            ...
            return (
              <div key={urgency}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className={`type-caption font-black uppercase tracking-widest ${cfg.color}`}>{cfg.label}</span>
                  <span className="type-caption text-slate-600">({group.length})</span>
                </div>
                      ...
                      <div className="flex items-center gap-3 shrink-0">
                        ...
                        {onOpenContract && (
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg type-caption font-bold text-white bg-white/10 hover:bg-white/15 border border-white/10 transition-all"
                          >

        ...
        <div className="flex flex-col gap-6 p-6 bg-[#000F15] border border-[#00FFD1]/20 font-mono text-[#00FFD1]">
            ...
            <div className="flex items-center justify-between border-b border-[#00FFD1]/10 pb-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 text-[10px] text-[#00FFD1]/60">
                ...
                <div className="flex gap-3">
                    <button className="px-4 py-2 border border-[#00FFD1]/20 hover:bg-[#00FFD1]/10 transition-colors flex items-center gap-2 text-[10px] font-bold">
                        <Pause className="w-3 h-3" /> PAUSE_SWARM
                    </button>
                    <button className="px-4 py-2 bg-red-500/10 border border-red-500/40 text-red-500 hover:bg-red-500/20 transition-colors flex items-center gap-2 text-[10px] font-bold">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-4">
                    <h3 className="text-[10px] font-bold tracking-widest text-[#00FFD1]/40 uppercase mb-4">Live_Agent_Deployments</h3>
                            ...
                            >
                                <div className="flex justify-between items-center text-[10px]">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="px-2 py-0.5 bg-[#00FFD1]/10 rounded-full text-[8px]">{agent.role}</span>
                                    </div>
                    ...
                    <div className="mt-8">
                        <h3 className="text-[10px] font-bold tracking-widest text-[#00FFD1]/40 uppercase mb-4">Next_Decisions_&_Reasoning</h3>
                        <div className="p-4 bg-black border border-[#00FFD1]/5 text-[10px] space-y-2 opacity-60">
                            <div className="flex gap-3">
                ...
                <div className="space-y-6">
                    ...
                    <div className="p-6 bg-[#001720] border border-[#00FFD1]/20 space-y-4 relative overflow-hidden">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-end border-b border-[#00FFD1]/5 pb-2">
                                <span className="text-[10px] text-[#00FFD1]/60 uppercase">System_Intelligence_Gain</span>
                                <span className="text-lg font-bold text-white">+12%</span>
                            </div>
                            <div className="flex justify-between items-end border-b border-[#00FFD1]/5 pb-2">
                                <span className="text-[10px] text-[#00FFD1]/60 uppercase">Predicted_Mission_Cap</span>
                        ...
                        <div className="p-3 bg-black border border-[#00FFD1]/5 flex items-center gap-3">
                            ...
                            <span className="text-[9px] text-[#00FFD1] leading-relaxed italic">
                    ...
                    <div className="p-6 bg-[#001D28] border border-[#00FFD1]/20 space-y-4">
                        ...
                        <p className="text-[8px] text-[#00FFD1]/40 italic">

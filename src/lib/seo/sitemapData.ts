...
export const RESOURCES_SITEMAP: MetadataRoute.Sitemap = [
  entry('/docs', 'weekly', 0.85),
  entry('/guide', 'monthly', 0.8),
  entry('/blog', 'weekly', 0.75),
  entry('/faq', 'monthly', 0.75),
  entry('/demo', 'monthly', 0.7),
  entry('/tools/ai-architect', 'monthly', 0.65),
];

export const COMPANY_SITEMAP: MetadataRoute.Sitemap = [
  entry('/platform-status', 'weekly', 0.75),
  entry('/security-policy', 'monthly', 0.7),
  entry('/compliance', 'monthly', 0.65),
  entry('/legal', 'monthly', 0.65),
  entry('/privacy-policy', 'yearly', 0.55),
  entry('/terms-of-service', 'yearly', 0.55),
  entry('/cookie-policy', 'yearly', 0.5),
  entry('/dpa', 'yearly', 0.5),
  entry('/data-deletion', 'yearly', 0.45),
  entry('/sla', 'yearly', 0.45),
  entry('/privacy-choices', 'yearly', 0.45),

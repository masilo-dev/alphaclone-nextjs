    ...
    <tr>
      <td align="center" style="padding:24px 12px;">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border:1px solid #e2e8f0;border-radius:8px;overflow:hidden;">
          <tr>
            <td style="background:linear-gradient(135deg,#0ea5e9 0%,#3b82f6 100%);padding:28px 24px;text-align:center;font-family:Arial,Helvetica,sans-serif;">
              <div style="font-size:22px;font-weight:bold;color:#ffffff;letter-spacing:0.3px;">Alphaclone Systems</div>
              <div style="font-size:13px;color:#e0f2fe;margin-top:6px;">The unified AI business operating system</div>
            </td>
          </tr>
          <tr>

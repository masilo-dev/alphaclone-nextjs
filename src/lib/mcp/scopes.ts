...
export const MCP_TOOL_REQUIRED_SCOPES: Record<string, McpScope[]> = {
  ...
  create_media_upload_session: [MCP_SCOPES.WRITE, MCP_SCOPES.TOOLS],
  upload_media_chunk: [MCP_SCOPES.WRITE, MCP_SCOPES.TOOLS],
  finalize_media_upload: [MCP_SCOPES.WRITE, MCP_SCOPES.TOOLS],

...
const EVENT_AGENT_MAP: Record<string, string[]> = {
  ...
  invoice_overdue: ['finance', 'accounting', 'email', 'customer_success', 'monitoring'],
  invoice_paid: ['finance', 'accounting', 'reporting', 'notification'],
  contract_signed: ['contracts', 'document', 'customer_success', 'finance'],
  task_overdue: ['coo', 'workflow', 'support', 'monitoring'],
  ...
  payment_failed: ['finance', 'accounting', 'support', 'notification'],
  employee_updated: ['coo', 'compliance'],
  approval_requested: ['compliance', 'audit', 'supervisor'],
  document_uploaded: ['document', 'knowledge', 'contracts'],
  social_post_published: ['social', 'marketing', 'reporting'],
  campaign_finished: ['marketing', 'reporting', 'email'],
  oauth_expiring: ['integration', 'security', 'notification', 'monitoring'],
  support_ticket_closed: ['support', 'customer_success', 'reporting'],
  calendar_changed: ['calendar', 'coo', 'notification'],
};

...
export const AGENT_FLEET: Record<AgentRole, AgentConfig> = {
    strategist: {
        id: 'strategist',
        model: 'deepseek-reasoner', // DeepSeek reasoning for elite planning
    ...
    executor: {
        id: 'executor',
        model: 'deepseek-chat', // DeepSeek chat for fast execution
    ...
    qa: {
        id: 'qa',
        model: 'deepseek-reasoner', // DeepSeek reasoning for high precision
    ...
    support: {
        id: 'support' as any,
        model: 'deepseek-chat', // DeepSeek chat for helpful customer support
        role: 'Bonnie',

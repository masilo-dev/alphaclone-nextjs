-- ============================================================================
-- SECURITY & ACTIVITY TRACKING - ADD TO EXISTING DATABASE
-- ============================================================================
-- This adds security features to your existing Supabase database
...
-- Pre-populate blocked countries (Nigeria & India)
...
-- ============================================================================
-- Tables created:
-- - activity_logs (user actions with IP tracking)
-- - login_sessions (session tracking with duration)
-- - blocked_countries (geo-blocking: Nigeria & India)
-- - security_alerts (suspicious activity alerts)
--
-- Features enabled:
-- - Automatic suspicious login detection

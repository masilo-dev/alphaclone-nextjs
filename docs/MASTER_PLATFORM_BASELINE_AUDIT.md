...
|---------|--------|----------|--------|--------|
| Baseline-2026-07-24 | Initial master baseline audit | This document @ `92415a4b` | Establishes scores | **Active** |
| (next) | After #65 merge to master | Re-run inventory + scorecard | Expect Security/Reliability ↑ | Pending |
| (next) | After CI restored | Re-check `gh pr checks` | Testing/SSDF ↑ | Pending |

...
import {
  ...
  WORKFLOW_STATES,
} from "../../src/lib/mcp/capabilityManifest.ts";
import {
  standardOk,
  standardError,
  approvalRequiredError,
  MCP_PROTOCOL_VERSION,
} from "../../src/lib/mcp/standardResponse.ts";
...
test("standard MCP success and approval error envelopes", () => {
  ...
  const err = approvalRequiredError(
    "publish_now",
    "appr-1",

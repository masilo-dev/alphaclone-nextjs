...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const cspHeader = `
      ...
      connect-src 'self' blob: https://*.supabase.co wss://*.supabase.co *.upstash.io *.stripe.com https://*.dicebear.com https://*.daily.co wss://*.daily.co https://*.livekit.cloud wss://*.livekit.cloud https://*.sentry.io https://cdn.jsdelivr.net https://challenges.cloudflare.com https://*.hubspot.com https://images.unsplash.com https://alphaclone.tech wss://alphaclone.tech https://api.anthropic.com https://api.openai.com https://openrouter.ai https://*.claude.ai https://nominatim.openstreetmap.org https://*.facebook.com https://*.instagram.com https://*.basemaps.cartocdn.com https://raw.githubusercontent.com https://unpkg.com https://www.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com https://graph.microsoft.com https://login.microsoftonline.com https://*.linkedin.com https://api.linkedin.com https://*.twitter.com https://api.twitter.com https://*.x.com https://api.x.com https://*.googleusercontent.com https://assets.mixkit.co https://files.manuscdn.com https://*.manuscdn.com;

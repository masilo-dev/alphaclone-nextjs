...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const cspHeader = `
      ...
      connect-src 'self' https://*.supabase.co wss://*.supabase.co *.upstash.io *.stripe.com https://*.dicebear.com https://*.daily.co wss://*.daily.co https://*.sentry.io https://cdn.jsdelivr.net https://challenges.cloudflare.com;
